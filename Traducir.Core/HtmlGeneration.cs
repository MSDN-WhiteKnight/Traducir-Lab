...
Source strings content is exported from <a href=""https://ru.stackoverflow.com"">Stack Overflow</a> localization system.</p><p>
...
Copyright (c) MSDN.WhiteKnight (other content)
        ...
        public static async Task StringsToHTML(IEnumerable<SOString> strings, TextWriter target)
        {
            ...
            await target.WriteLineAsync("<p><i>updated " + DateTime.Now.ToString(CultureInfo.InvariantCulture) + "</i></p>");
            ...
            foreach (SOString str in strings)
            {
                ...
                await target.WriteAsync(str.CreationDate.ToString(CultureInfo.InvariantCulture) + " - ");
        ...
        public static async Task HistoryToHTML(SOStringService svc, SOString str, TextWriter target)
        {
            ...
            await target.WriteAsync("<b>Created:</b> " + str.CreationDate.ToString(CultureInfo.InvariantCulture) + "</p>");
            ...
            for (int i = 0; i < suggestions.Length; i++)
            {
                ...
                for (int j = 0; j < suggestions[i].Histories.Length; j++)
                {
                    ...
                    await target.WriteAsync("<td>" + hist.CreationDate.ToString(CultureInfo.InvariantCulture) + "</td>");
